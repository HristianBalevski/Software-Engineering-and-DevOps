...
### Какво представлява Web UI тестването?

- **Web UI тестването** проверява компонентите, с които потребителите взаимодействат директно.
- Основна цел е да гарантира, че интерфейсът отговаря на изискванията за:
  - **Потребителско изживяване (User Experience):**  
    UI е първата точка на контакт на потребителя с приложението.
  - **Функционалност:**  
    Всички визуални компоненти трябва да работят правилно.
  - **Съвместимост:**  
    Уверява се, че приложението изглежда правилно на различни устройства.
  - **Производителност:**  
    Проверява как интерфейсът се справя при различни условия.

---

### Основни видове UI тестване:

1. **Функционално тестване:**

   - Проверява дали всеки елемент на интерфейса работи правилно при взаимодействие.

2. **Тестване на различни браузъри (Cross-Browser Testing):**

   - Проверява дали UI се рендерира и функционира коректно в различни браузъри.

3. **Респонсивно тестване (Responsive Testing):**

   - Уверява се, че интерфейсът се адаптира правилно към различни размери на екрана.

4. **Тестване за достъпност (Accessibility Testing):**

   - Проверява дали UI е достъпен за потребители с увреждания.

5. **Визуално регресионно тестване (Visual Regression Testing):**
   - Проверява за визуални промени след актуализации.

---

### Инструменти за Web UI тестване

#### **Playwright:**

- Библиотека за **end-to-end тестване** на web приложения, базирана на Node.js.
- **Основни характеристики:**
  - Автоматизира задачи в браузъра (например формуляри, взаимодействия с UI, въвеждане от клавиатура).
  - Поддържа всички съвременни браузъри.
  - Изключително бърз и мащабируем, с възможност за работа в headless режим (без UI).
...
- **Преглед:**
  ...
  - Един от най-популярните инструменти за автоматизация на браузъри.
  - Полезен за тестване на различни браузъри.
  - Работи с множество програмни езици.

- **Основни компоненти:**
  - **Selenium IDE:**
    - Инструмент за записване и изпълнение на тестове.
  - **Selenium WebDriver:**
    - Интерфейс за управление на браузъри чрез код.
  - **Selenium Grid:**
    - Позволява разпределено тестване на различни браузъри и операционни системи.

Тестването на Web UI е ключово за осигуряване на добро потребителско изживяване, функционалност и съвместимост на приложенията.
...
CI/CD е набор от процеси, които автоматизират внедряването на нов код от момента на комит до пускането му в продукционна среда.

---

### Основни принципи на CI/CD:

1. **Непрекъсната интеграция (Continuous Integration - CI):**  
   - Разработчиците редовно сливат своите промени в централно репозитори.  
   - Всеки нов код автоматично се тества, за да се гарантира неговата стабилност.  

2. **Непрекъсната доставка (Continuous Delivery - CD):**  
   - След успешното тестване кодът е подготвен за внедряване в продукция.  
   - Внедряването може да бъде извършено ръчно по всяко време.  

3. **Непрекъснато внедряване (Continuous Deployment - CD):**  
   - Автоматично внедряване на кода в продукционна среда, след като тестовете преминат успешно.  
   - Няма нужда от ръчна намеса.  

<img width="864" alt="Screenshot 2025-02-01 at 03 38 10" src="https://github.com/user-attachments/assets/606be565-4206-4ef9-9ff9-f7611266238a" />

---

### Основни ползи:

- **Автоматизира голяма част от процеса по внедряване на нов код.**  
- **Осигурява чести и надеждни софтуерни актуализации.**  
- **Намалява риска от грешки чрез автоматизирани тестове.**  
- **Подобрява ефективността и скоростта на разработка.**  

CI/CD е ключова практика за модерната софтуерна разработка, която гарантира бързо, надеждно и безпроблемно внедряване на код.

## Continuous Testing - CT

### Какво представлява Continuous Testing?

- **Непрекъснатото тестване (CT)** включва редовно изпълнение на автоматизирани тестове като част от софтуерния процес на доставка.  
- Основната цел е да гарантира **последователно високо качество** на софтуера.  

---

### Как се прилага Continuous Testing?

- **Интегрира се с CI/CD системи**  
- **Автоматизираните тестове се изпълняват в различни фази:**  
  1. **Unit Tests** – изпълняват се при всеки комит / пуш.  
  2. **Integration Tests** – изпълняват се при по-значими промени.  
  3. **End-to-end Tests** – изпълняват се всяка вечер (защото отнемат повече време).  

---

### Ползи от Continuous Testing:

- **Ранно откриване на бъгове.**  
- **Постоянна проверка на качеството.**  
- **Гарантира, че новият код не нарушава съществуващите функционалности.**  
- **Автоматизирана и ефективна проверка на софтуера в различни фази.**  

Continuous Testing е критична част от CI/CD процеса, която позволява по-бързо и по-надеждно разработване на софтуер.

## CI/CD Pipeline View

<img width="1376" alt="Screenshot 2025-02-01 at 03 51 51" src="https://github.com/user-attachments/assets/e2323943-40f5-4479-98da-72505a9e5d40" />

## CI/CD & Software Development Environments

CI/CD процесът преминава през няколко основни среди, всяка от които има своя роля в разработката, тестването и внедряването на софтуера.

---

### **Основни среди в CI/CD:**

1. **Development Environment (Среда за разработка):**  
   - Разработчиците пишат код и извършват първоначални тестове.  
   - Кодът се комитва в репозиторито.  

2. **Testing Environment (Тестова среда):**  
   - **CI (Continuous Integration):**  
     - Автоматизирано тестване на новия код при всяка промяна.  
     - Включва **юнит тестове, интеграционни тестове** и други.  

3. **Staging Environment (Стейджинг среда):**  
   - **CD (Continuous Delivery):**  
     - Подготовка на софтуера за продукция.  
     - Провеждане на тестове за приемане от потребители (User Acceptance Testing - UAT).  

4. **Production Environment (Продукционна среда):**  
   - **CD (Continuous Deployment):**  
     - Кодът се внедрява автоматично, ако всички тестове преминат успешно.  
   - **Monitoring (Мониторинг):**  
     - Следи се поведението на софтуера в реална среда.  

---

### **CI/CD процесът гарантира:**
✔ Автоматизация на тестовете и внедряването.  
✔ По-бързи и стабилни релийзи.  
✔ Ранно откриване и предотвратяване на грешки.  
✔ Постоянно наблюдение и подобрение на софтуера.

CI/CD осигурява ефективен и надежден софтуерен цикъл, като автоматизира разработката, тестването и внедряването.

## CI/CD Принципи и Ползи

### **Основни принципи на CI/CD:**

1. **Single Source Repository:**  
   - Всички необходими компоненти за изграждане на приложението се съхраняват в едно репозитори.  
   - Включва **изходен код, база данни, библиотеки, скриптове** и други ресурси.  

2. **Чести итерации и комити към основния клон:**  
   - Кодът се разработва на малки части и се слива често, за да се избегнат големи конфликти.  

3. **Автоматизирани и самотестващи се билдове:**  
   - Всеки билд преминава през тестове, за да се гарантира стабилността на кода.  

---

### **Ползи от CI/CD:**

✔ **По-висока ефективност на внедряването:**  
   - Автоматизира процеса на разгръщане, което ускорява разработката.  

✔ **По-нисък риск от дефекти:**  
   - Честото тестване и интеграция намаляват вероятността от грешки.  

✔ **По-бърза доставка на продукта:**  
   - Автоматизацията позволява по-кратки цикли на издаване на нови версии.  

✔ **Генериране на детайлни логове:**  
   - Логовете от CI/CD предоставят подробна информация за промените и грешките.  

✔ **По-лесно връщане на кодови промени (Rollback):**  
   - Ако възникне проблем, кодът може бързо да бъде върнат към предишна стабилна версия.  

✔ **По-надеждни тестове:**  
   - Автоматизираното тестване гарантира по-добро покритие и стабилност.  

✔ **Повишено удовлетворение на клиентите:**  
   - По-бързи и надеждни актуализации водят до по-добро потребителско изживяване.  

---

CI/CD осигурява **стабилност, ефективност и бързина**, като автоматизира жизнения цикъл на разработка и внедряване на софтуер.

## CI/CD Systems

<img width="1478" alt="Screenshot 2025-02-01 at 03 57 15" src="https://github.com/user-attachments/assets/88823eb8-3aa8-4e46-9b3c-a111b10970e1" />

## Въведение в GitHub Actions

### **Основни концепции:**

- **Събития (Events)** задействат **работни процеси (Workflows)**.  
- **Работните процеси (Workflows)** съдържат **работни задачи (Jobs)**.  
- **Работните задачи (Jobs)** съдържат **стъпки (Steps)**.  
- **Стъпките (Steps)** съдържат **действия (Actions)** (например `dotnet test`).

<img width="402" alt="Screenshot 2025-02-01 at 04 03 09" src="https://github.com/user-attachments/assets/0b97a57b-e139-49c9-8197-2a3a88e348c1" />


---

### **Събития (Events) в GitHub Actions**

Събитията са конкретни тригери, които активират работни процеси в репозитория.  
Позволяват автоматизация на различни задачи, като:  
...
### **Видове събития в GitHub Actions:**

1. **Repository Events:**  
   - Задействат се от действия в репозиторито (например `git push`, `pull request`).  

2. **Workflow Events:**  
   - Свързани със самите работни процеси, например стартиране на нов workflow.  

3. **Webhook Events:**  
   - Задействат се от външни услуги, интегрирани чрез уебхукове.  

4. **External Events:**  
   - Свързани с действия, предприети от външни услуги.  

5. **Internal Events:**  
   - Свързани с действия в рамките на организацията или самото GitHub репозитори.  

---

### **GitHub Actions автоматизират жизнения цикъл на софтуера**, като позволяват автоматично изграждане, тестване и внедряване на код при всяка промяна.

## **GitHub Actions Workflow**

<img width="1575" alt="Screenshot 2025-02-01 at 04 10 06" src="https://github.com/user-attachments/assets/0e309f67-8bb5-4873-8ce4-3c05a438e681" />

## Jobs

<img width="1496" alt="Screenshot 2025-02-01 at 04 10 58" src="https://github.com/user-attachments/assets/314be958-19a6-4544-9018-469a0ac64420" />

## Runners

<img width="1526" alt="Screenshot 2025-02-01 at 04 11 56" src="https://github.com/user-attachments/assets/a631226d-fb00-4155-9a4f-d060c1b757d4" />

## Steps and Actions

<img width="1550" alt="Screenshot 2025-02-01 at 04 12 43" src="https://github.com/user-attachments/assets/189c6b9f-8e90-4bce-b2bc-df6dbe7d79a3" />

##  Workflow Syntax Keywords

<img width="1550" alt="Screenshot 2025-02-01 at 04 14 16" src="https://github.com/user-attachments/assets/0ea80299-3614-4735-819e-11bd7f7c2077" />
<img width="1327" alt="Screenshot 2025-02-01 at 04 15 05" src="https://github.com/user-attachments/assets/137a8913-33c0-4e53-bfa7-4a25b52c2c6b" />

## GitHub Marketplace

<img width="1587" alt="Screenshot 2025-02-01 at 04 16 14" src="https://github.com/user-attachments/assets/2f44b1ee-8eaf-412f-9a10-c7e1fe40fed0" />

## **YAML – Определение и Синтаксис**

### **Какво е YAML?**
- **YAML (YAML Ain't Markup Language)** – език за сериализация на данни, четим за хора.  
- Първоначално е означавал **"Yet Another Markup Language"**, но се фокусира върху **чистата сериализация на данни**.  
- **Широко използван в DevOps** за конфигурация, управление на системи и CI/CD процеси.  
- **Основен формат** за разгръщане и настройка на софтуерни среди.  

---

### **Синтаксис на YAML**
#### **1. Отстъпи**
- **Структурата се определя чрез отстъпи с интервали.**  
- **Табулации не са позволени.**  

#### **2. Ключ-стойност (Key-Value Pairs)**
- Основната структура в YAML е **карта от ключове и стойности**.  
- Разделени са чрез **двоеточие (`:`)**.  
  ```yaml
  име: "Иван"
  възраст: 30
...
#### **4. Разширени структури**

Вложени структури (Nested Structures)
...
- Включват низове, числа и булеви стойности.
- Не е задължително да се използват кавички, освен ако низът съдържа специални символи.
...
#### Заключение
YAML е мощен и четим формат, широко използван в DevOps за конфигурация и автоматизация.
Той е лесен за разбиране, но изисква внимателно спазване на отстъпите и синтаксиса.

---

# 05. Continuous Integration and Continuous Delivery (CI/CD) with Jenkins

### **Какво е Jenkins?**
- **Jenkins** е **сървър за автоматизация с отворен код**, предназначен за улесняване на **CI/CD** процесите.  
- **Поддържа множество платформи и програмни езици.**  
- Разполага с **богата екосистема от плъгини**, които позволяват интеграция с различни инструменти и технологии.  
- **Опростява изграждането на CI/CD pipelines.**  

---

## **Основни характеристики и предимства на Jenkins**

### **1. Уеб-базиран интерфейс**
✔ Лесна конфигурация и управление на CI/CD процесите.  
✔ Не изисква писане на сложни скриптове.  

### **2. Разширяемост (Extensibility)**
✔ Чрез **архитектурата на плъгини**, която предоставя множество опции за автоматизация.  

### **3. Поддръжка на разпределени билдове (Distributed Builds)**
✔ Позволява използването на **няколко билд агенти, работещи паралелно.**  
✔ **Оптимизира използването на ресурси** и ускорява процеса на разработка.  

Jenkins е мощен инструмент за автоматизация, който позволява ефективно управление на софтуерния цикъл на разработка, от интеграция до внедряване.
...
- **Jenkins Pipelines** представляват **набор от плъгини**, които позволяват интеграция и изпълнение на **CD (Continuous Delivery) тръбопроводи**.  
- Осигуряват **DSL (Domain-Specific Language)** за дефиниране на стъпките в процеса на доставка на софтуер.  
- **Автоматизират целия процес на доставка** и гарантират, че софтуерът **винаги е в състояние на готовност за пускане**.  

---

## **Основни компоненти на Jenkins Pipeline**
1. **Stages (Етапи):**  
   - Високо ниво на организация на основните дейности в един pipeline.  
   - **Примери:** Build, Test, Deploy.  

2. **Steps (Стъпки):**  
   - Конкретни задачи в рамките на всеки етап.  

3. **Nodes (Възли):**  
   - Определят **системата или агента**, върху който ще се изпълнява pipeline или конкретен етап.  

4. **Agents (Агенти):**  
   - Указват **къде** да бъде изпълнен pipeline-ът.  

---

## **Pipeline as Code**
- Подход, който **третира CI/CD процесите като част от кода на приложението**.  
- **Основни предимства:**  
  ✔ Позволява **сътрудничество** при проектиране и промени.  
  ✔ **Проследява** и запазва историята на промените.  
  ✔ **Прозрачност** – всички членове на екипа могат да виждат логиката на pipeline-а и да разбират процеса на доставка.  

---

## **Jenkinsfile – основен компонент на Pipeline as Code**
- **Jenkinsfile** дефинира конфигурацията на pipeline-а като код.  
- Описва **етапите, стъпките и действията**, които Jenkins ще изпълни по време на **изграждане, тестване и внедряване**.  
- Обикновено се намира в **основната директория на проекта**.  
  - Поддържа **ревизии и версиониране**.
   
- Използва **Groovy**, като предоставя **две основни синтактични вариации**:  
  1. **Declarative Pipeline** – по-лесен за разбиране и управление.  
  2. **Scripted Pipeline** – по-гъвкав, но по-сложен.  

Jenkins Pipelines предоставят **мощен и мащабируем начин** за автоматизация на CI/CD, като осигуряват **гъвкавост, проследимост и ефективност** в процеса на доставка на софтуер.

---

# **Основни концепции в Jenkins**

## **Събития (Events)**
- **Събитията задействат изпълнението на Jenkins задачи или CI/CD pipeline-и.**  
- Могат да бъдат **активирани от външни тригери**, като:  

✔ **Промени в изходния код** – напр. commit или merge в Git.  
✔ **Ръчно стартиране** – чрез Jenkins UI.  
✔ **Upstream/Downstream тригери** – завършване на друга Jenkins задача.  
✔ **Разписание** – изпълнение в определено време (cron job).  

---

## **Работни процеси (Workflows)**
- Високо ниво на дефиниция на целия процес по внедряване на софтуера.  
- Описани в **Jenkinsfile** и съхранени в изходния код.  
- Позволяват **версиониране и преглед на промените**.  
- Поддържат **сложна логика**, като:  
  - **Условно изпълнение**.  
  - **Паралелни стъпки**.  
...
## **Задачи (Jobs)**
- Основната **изпълнима единица в Jenkins**.  
- **Дефинирани в pipeline-а**, могат да включват няколко етапа (**stages**).  
- Приемат **параметри**, за да модифицират процеса на изграждане.  
- Съхраняват **артефакти (binaries, доклади и други)** и записват резултатите от билдовете.  

---

## **Стъпки (Steps)**
- **Индивидуални задачи** в рамките на Jenkins job.  
- Могат да бъдат:  
  ✔ **Команди в декларативен синтаксис**.  
  ✔ **Скриптови команди (Shell, Batch)**.  
...
## **Действия (Actions)**
- Реалните **операции, изпълнявани от стъпките**.  
- **Функции, които:**
  - Взаимодействат с работната среда (workspace).  
  - Променят състоянието на билда.  
  - Изпращат известия.  

Jenkins предоставя **мощна архитектура за автоматизация**, която позволява детайлно конфигуриране на CI/CD процесите чрез събития, работни процеси и jobs.

---

# **Jenkins Pipeline – Основни ключови думи в синтаксиса**

### 1. pipeline
- Дефинира **основния блок**, в който е описан целият процес на pipeline-а.
...
### 2. agent
- Определя къде ще бъде изпълнен целият pipeline или даден етап в Jenkins средата.

```
pipeline {
    agent { label 'docker' }  // Изпълнение на агент с име 'docker'
}
```

### 3. stages
- Съдържа последователност от етапи (stages), които ще бъдат изпълнени в дефиниран ред.
...
### 4. stage
- Определя **концептуално отделен етап** от целия pipeline.
...
### 5. steps
- Определя една или повече конкретни стъпки, които да бъдат изпълнени в даден етап.
...
### 6. script
- Позволява включването на произволен Groovy код.
...
### 7. environment
- Дефинира променливи на средата, които могат да се използват в стъпките.
...
### 8. post
- Определя допълнителни стъпки, които ще се изпълнят след завършване на pipeline-а.
...
### Заключение
Jenkins Pipeline използва декларативен синтаксис, базиран на Groovy, който позволява гъвкаво и четимо конфигуриране на CI/CD процесите.

---

# **Архитектура на Jenkins**

## **1. Разпределена архитектура**
- Jenkins **следва разпределена архитектура**, която позволява **мащабируемост и ефективност**.  
- Основният компонент е **контролерът (controller)**, който управлява изпълнението на задачи.  
- **Разпределената природа** на Jenkins позволява **стартиране на задачи на различни машини (агенти)**.  

---

## **2. Модел "Контролер / Агент"**
### **Контролер (Controller)**
- Отговаря за **планирането на задачи, разпределянето на билдове и мониторинга**.  
- Преди се наричаше **Master**.  
- Управлява цялата Jenkins среда.  

### **Агенти (Agents)**
- Физически или виртуални машини, които **изпълняват Jenkins jobs**.  
- Позволяват **изграждането и тестването в различни среди**.  
- **Разпределено изграждане:**  
  - **Няколко агента могат да работят едновременно**.  
  - **Оптимизират използването на ресурси**.  

---

## **3. Мащабируемост, балансиране на натоварването и сигурност**
✔ **Jenkins се мащабира хоризонтално**, като добавя повече агенти.  
✔ Автоматично **разпределя задачи между наличните агенти** според техните конфигурации.  
✔ Поддържа **различни механизми за автентикация**.  
✔ **Комуникацията между контролера и агентите може да бъде криптирана**, за да осигури сигурност на кода и резултатите от билдовете.  

---

## **4. Архитектура на плъгините**
- **Плъгините са основният начин за разширяване на функционалността на Jenkins.**  
- Има **хиляди плъгини**, които позволяват:  
  ✔ Интеграция с различни инструменти и технологии.  
  ✔ Разширяване на възможностите за автоматизация.  
  ✔ По-леко ядро на Jenkins с възможност за надграждане според нуждите.  

---

## **Заключение**
Архитектурата на Jenkins е **гъвкава, разпределена и разширяема**, което я прави **идеален избор за CI/CD** с възможност за **мащабиране, баланс на натоварването и висока сигурност**.

# **Обобщение**

✔ **Jenkins** е **сървър за автоматизация с отворен код**, който улеснява **CI/CD процесите**.  

✔ **Jenkinsfile** е конфигурационен файл, който следва **Pipeline as Code** философията и дефинира процесите по интеграция и доставка на софтуер.  

✔ **Jenkins използва разпределена архитектура** с **контролер и агенти**, което позволява **гъвкавост, мащабируемост и ефективност**.  

✔ **Разширяемост чрез плъгини** – богатата екосистема от плъгини прави Jenkins **изключително персонализируем и съвместим с различни технологии**.  

🚀 **Jenkins е мощен инструмент за автоматизация**, който осигурява **гъвкава, сигурна и ефективна платформа** за CI/CD.
...
## **Въведение**
- **Работният процес при разработка** е набор от процедури, които екипът по разработка използва, за да **превърне потребителска история в работещ софтуер**.  
- Включва **кодиране, билд процеси и автоматизация, тестване** и изпълнение на приложението в различни среди.  

---

## **Основни цели на Development Workflow:**
✔ **Оптимизиране на работните процеси**.  
✔ **Облекчаване на сложността** при разработката на софтуерни проекти.  
✔ **Гарантиране на високо качество** чрез ефективно управление.  
✔ **Намаляване на забавянията** в разработката.  
✔ **Осигуряване на гъвкав (Agile) подход** за бърза адаптация и подобрение.  

---

Правилният **работен процес при разработка** подобрява **ефективността на екипа** и гарантира **плавен и структуриран път** от идеята до внедряването на софтуерния продукт.


# **Issues Flow**

## **Какво представлява Issues Flow?**
- **Работният процес при разработка** включва **различни етапи за управление на задачи и проблеми (issues)**.  
- **Основна цел:** Осигурява **структуриран и организиран подход** към разработката на софтуер.  

---

## **Основни принципи на управление на задачи:**
✔ **Визуализация** – използване на **Trello Board, GitHub Project Board, Jira Board** или други инструменти за управление на задачи.  
✔ **Систематичен подход** – задачите се обработват поетапно, за да се гарантира контрол и ефективност.  
✔ **Сътрудничество и прозрачност** – всички членове на екипа имат видимост върху текущия статус на задачите.  
✔ **Ефективна доставка** – подобрява управлението на приоритети и намалява забавянията.  

---

## **Как работи процесът на управление на задачи?**
1️⃣ **Създаване на задача (Issue Creation):** Определяне на проблема или новата функционалност.  
2️⃣ **Приоритизиране (Prioritization):** Определяне на важността на задачата.  
3️⃣ **Присвояване (Assignment):** Назначаване на отговорник.  
4️⃣ **Работа по задачата (In Progress):** Активна разработка и тестване.  
5️⃣ **Преглед (Review):** Проверка на кода и функционалността.  
6️⃣ **Затваряне (Close/Done):** След успешно завършване и внедряване.  

---

**Процесът на управление на задачи е критична част от разработката**, която гарантира **ясно дефинирани задачи, ефективна комуникация и по-бърза доставка на качествен софтуер**.

# Types of Issues

## **Основни етапи в управлението на задачи:**

### **1. Pending (Чакащи)**
- **Описание:**  
  - Задачи, които чакат да бъдат разгледани и приоритизирани.  
- **Статус:**  
  - Все още не е взето решение кога ще бъдат обработени.  

---

### **2. Sprint TODO (Задачи за текущия спринт)**
- **Описание:**  
  - Избрани задачи, които ще бъдат изпълнени в рамките на текущия **спринт** (Agile среда).  
- **Статус:**  
  - Готови за започване на работа.  

---

### **3. In Progress (В процес на изпълнение)**
- **Описание:**  
  - Задачи, по които **разработчиците активно работят**.  
  - Включва имплементиране на нови функции или разрешаване на проблеми.  
- **Статус:**  
  - Кодът се пише и се подготвя за тестване.  

---

### **4. For Testing (Готови за тестване)**
- **Описание:**  
  - Разработените задачи са завършени и **изчакват тестване от QA екипа**.  
- **Статус:**  
  - Очакват верификация преди пускане в продукция.  

---

### **5. Verified (Потвърдени)**
- **Описание:**  
  - **QA тестовете са завършени успешно**, но може да изискват допълнителни стъпки.  
- **Статус:**  
  - Готови за финални действия преди внедряване.  

---

### **6. For Deploy (Готови за внедряване)**
- **Описание:**  
  - Тестван и **одобрен код**, който може да бъде пуснат в продукционна среда.  
- **Статус:**  
  - Очаква разгръщане.  
...
### **7. Done (Изпълнени)**
- **Описание:**  
  - Задачата е **успешно внедрена** и няма нужда от допълнителни действия.  
- **Статус:**  
  - Завършена и затворена.  

---

**Процесът на управление на задачи гарантира плавно и организирано преминаване на всяка задача** от първоначалното ѝ създаване до успешното ѝ внедряване.
...
## 🚀 **Как DevOps зависи от структурата на организацията?**
DevOps изисква не само нови технологии и процеси, но и **промяна в начина, по който са организирани екипите**.  
**Agile е основен принцип на DevOps** – организацията трябва да възприеме гъвкавостта и колаборацията, за да бъде успешна.  

✅ **Какви трябва да бъдат Agile екипите?**  
- 🔹 **Малки** – с максимум 5-10 инженери.  
- 🔹 **Отдадени** – не трябва да работят по няколко проекта едновременно.  
- 🔹 **Крос-функционални** – трябва да включват всички необходими роли: **софтуерни инженери, тестери, DevOps специалисти, анализатори и др.**  
- 🔹 **Самоорганизиращи се** – без бюрокрация, с бързи решения и автономия.  

---

## 🏗 **Как Conway’s Law влияе върху софтуерната архитектура?**
📌 **През 1968 г. Мелвин Конуей формулира закон, който гласи:**  
> "Всяка организация, която проектира система, ще създаде архитектура, която отразява комуникационната структура на организацията."

💡 **Пример:**  
- Ако имате **четири независими екипа**, те ще създадат **четиристепенен компилатор**.  
- Ако има **UI екип, backend екип и DBA екип**, резултатът ще бъде **трислойна архитектура**.  
- Ако искате **микросервизна архитектура**, трябва да организирате **екипите по бизнес домейни**, а не по технологии.

---

## 🏢 **Традиционна vs. Домейн-ориентирана организация**
❌ **Традиционен модел (по технологии):**
- **UI екип** – създава потребителския интерфейс.
- **Backend екип** – пише бизнес логиката.
- **DBA екип** – управлява базите данни.
- ➡️ **Резултат:** Забавяне, чакане на отговори от други екипи, бюрократични процеси.

✅ **Домейн-ориентиран модел (по бизнес функции):**
- **Екип за акаунти** – отговаря за логин, регистрация, потребителски данни.
- **Екип за персонализация** – разработва AI алгоритми за персонализиране.
- **Екип за складова наличност** – управлява доставка, наличности и логистика.
- ➡️ **Резултат:** По-бърза разработка, по-малко зависимости, гъвкавост.

---

## 🔥 **Как да изградим успешен DevOps екип?**
✅ **Организирайте екипите около бизнес домейни, а не около технологии.**  
✅ **Дайте на екипите автономия – да разработват, внедряват и поддържат собствения си код.**  
✅ **Стабилни екипи с дългосрочна мисия** – няма смисъл хората да се разпределят постоянно по нови проекти.  
✅ **Разбийте силозите!** – няма място за разделение между Dev, QA, Ops и Security.  

---

## 🎯 **Заключение**
🔹 **Организацията влияе директно върху архитектурата на софтуера (Conway’s Law).**  
🔹 **Малки, самоорганизиращи се, крос-функционални екипи са ключови за успешен DevOps.**  
🔹 **Домейн-ориентирани екипи постигат по-голяма гъвкавост и ефективност.**  
🔹 **Разбийте традиционните технологични силози и дайте на екипите пълна отговорност!**  

🚀 **DevOps не е просто технология – това е култура, базирана на автономия и колаборация!**
