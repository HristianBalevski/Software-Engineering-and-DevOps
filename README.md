...
1. **Development Environment (Среда за разработка):**  
   ...
   - Кодът се комитва в репозитория.  
...
1. **Единен източник на истина (Single Source Repository):**  
   - Всички необходими компоненти за изграждане на приложението се съхраняват в един репозиториум.  
...
1. **Repository Events (Репозиториумни събития):**  
   - Задействат се от действия в репозитория (например `git push`, `pull request`).  

2. **Workflow Events (Събития за работни процеси):**  
   - Свързани със самите работни процеси, например стартиране на нов workflow.  

3. **Webhook Events (Уебхук събития):**  
   - Задействат се от външни услуги, интегрирани чрез уебхукове.  

4. **External Events (Външни събития):**  
   - Свързани с действия, предприети от външни услуги.  

5. **Internal Events (Вътрешни събития):**  
